...
# ---- Chart 2: Movie Count Per Genre Combination (Top 10) ----
st.subheader("🥧 Movie Count Per Genre Combination (Top 10)")
...
if not genre_count_df.empty:
    ...
    fig = px.pie(
        ...
        values="movie_count",
        names="genres",
        title="Top 10 Genre Combinations by Movie Count",
    ...
    st.info("No genre data available for this chart.")
